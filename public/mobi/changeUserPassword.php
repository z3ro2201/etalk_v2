                    ...
                    <form id="frmProc" action="/mobi/etalkProc" method="post">
                        <div class="card m-1 p-2">
                            <div class="rows p-3 text-dark" id="sheet1">
                                <label For="" class="form-label">변경하실 2차 비밀번호를 입력하세요.</label>
                                ...
                                <input type="hidden" name="ussn" id="ussn" value="<?=$_SESSION['user_ssn'];?>"/>
                                <input type="hidden" name="proc" value="changePasswd"/>
                                <div id="secKeypad">
