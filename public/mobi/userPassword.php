                    ...
                    <form id="frmProc" action="/mobi/etalkProc" method="post">
                        <div class="card m-1 p-2">
                            <div class="rows p-3 text-dark" id="sheet1">
                                ...
                                <input type="hidden" name="proc" value="2ndlogin"/>
                                <div id="secKeypad">
                            ...
                            <div class="rows p-3 text-dark d-grid gap-2">
                                <button type="button" id="btnsubmit" onclick="login();" class="btn btn-primary p-3">로그인</button>
                                <button type="button" id="btnlogout" name="btnLogout" class="btn btn-primary p-3" onclick="logout();">다른계정으로 로그인</button>
                            </div>
                        </div>
                    </form>
                </section>
